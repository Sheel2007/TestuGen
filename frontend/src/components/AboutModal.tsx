      ...
      >
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="flex items-center gap-3">
            <img src="/favicon.svg" alt="OrbitTerp" className="w-9 h-9 flex-shrink-0" />
            <h2 className="text-xl font-bold">About OrbitTerp</h2>
          </div>

          {/* Description */}
          <p className="text-gray-300 text-sm leading-relaxed">
            OrbitTerp helps University of Maryland students build the best possible class schedule.
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              OrbitTerp was heavily inspired by{' '}
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              OrbitTerp is completely open source. Check out the code on{' '}
          ...
          <p className="text-gray-600 text-[11px] text-center">
            OrbitTerp is not affiliated with the University of Maryland.
          </p>
        </div>
      </div>
    </div>
